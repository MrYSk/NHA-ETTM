...
export const queryKeys = {
  ...
  reporting: (filters: unknown) => ['reporting', filters] as const,
  reportingSites: () => ['reporting', 'sites'] as const,
  reportingEmployees: () => ['reporting', 'employees'] as const,
  reportingMonths: () => ['reporting', 'months'] as const,
  summarySites: () => ['summary', 'sites'] as const,
